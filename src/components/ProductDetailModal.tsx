...
import { X, Star, Plus, Minus, Check, MessageCircle, ShieldCheck, Truck, RefreshCw, Zap } from 'lucide-react';
...
export const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Card */}
      <div className="relative w-full max-w-3xl bg-[#13151F] border border-white/10 rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,229,255,0.2)] z-10 my-auto glass">
        
        {/* Close Button */}
        <button
          onClick={onClose}
          aria-label="Fechar detalhes"
          className="absolute top-4 right-4 z-20 p-2 rounded-full bg-[#090A0F]/90 text-slate-400 hover:text-white hover:bg-white/10 border border-white/10 transition-all cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 max-h-[85vh] overflow-y-auto">
          ...
          <div className="relative bg-[#090A0F] flex flex-col items-center justify-center p-6 border-b md:border-b-0 md:border-r border-white/10">
            <div className="w-full aspect-square relative rounded-2xl overflow-hidden border border-white/5">
              <img
                src={product.image}
                alt={product.name}
          ...
          <div className="p-6 sm:p-8 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              {/* Price */}
              <div className="p-4 rounded-2xl bg-[#090A0F] border border-white/10 flex items-center justify-between">
                <div>
            ...
            <div className="pt-4 border-t border-white/10 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center bg-[#090A0F] border border-white/10 rounded-2xl p-1">
                  <button
                    ...
                    disabled={quantity <= 1}
                    className="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 disabled:opacity-30 cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <button
                  onClick={handleAdd}
                  className={`w-full py-4 px-4 rounded-2xl font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all cursor-pointer ${
                    isAdded
                ...
                <button
                  ...
                  className="w-full py-4 px-4 rounded-2xl bg-[#25D366] hover:bg-[#20ba5a] text-black font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(37,211,102,0.35)] transition-all cursor-pointer"
                >
